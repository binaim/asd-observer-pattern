...
public class LabSubject extends JFrame {

    private ObservableCounter counterSubject;
    ...
    public LabSubject()
    {
        ...
        TextFrameObserver textf = new TextFrameObserver();
        textf.setVisible(true);
        textf.setBounds(250, 0, 300, 200);

        RectFrameObserver rectf = new RectFrameObserver();
        rectf.setVisible(true);
        rectf.setBounds(250, 200, 300, 200);

        OvalFrameObserver ovalf = new OvalFrameObserver();
        ovalf.setVisible(true);
        ovalf.setBounds(250, 400, 300, 200);

        counterSubject = new ObservableCounter();
//
//       counterSubject.addObservers(textf);
//       counterSubject.addObservers(rectf);
//       counterSubject.addObservers(ovalf);

        counterSubject.addObserver(textf);
        counterSubject.addObserver(rectf);
        counterSubject.addObserver(ovalf);
    ...
    static public void main(String args[])
    {
        try {
            ...
            (new LabSubject()).setVisible(true);
        }
        catch (Throwable t) {
